...
file_name = 'manage.py'
command_name = 'removeAwayUsers'
full_path = os.path.join(path, file_name)
log_file_name1 = 'logFileSourceAway'
log_file_err1 = 'logFileErrSourceAway'
log_file_name2 = 'logFilePythonAway'
log_file_err2 = 'logfileErrPythonAway'
